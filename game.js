...
const MISSIONS = [
  {
    ...
    contentKo: '모둠원이 돌아가며 자신을 형용사 한 단어로 표현하세요. 말 못 하면 손동작도 OK!',
    contentId: 'Setiap anggota menyebutkan satu kata sifat yang menggambarkan diri mereka. Gerak tangan juga boleh!',
  },
  {
    sel: '대인관계',
    titleKo: '우리 모둠 공통점 1개 외치기',
    titleId: 'Teriakkan 1 kesamaan kelompok!',
    contentKo: '인도네시아 친구 포함, 30초 안에 공통점 1개를 찾아 크게 외치세요!',
    contentId: 'Termasuk teman Indonesia, temukan 1 kesamaan dalam 30 detik dan teriakkan bersama!',
  },
  {
    sel: '공동체',
    titleKo: '"먼저 ○○, 그다음 ○○"',
    titleId: '"Pertama ○○, lalu ○○"',
    contentKo: '제시된 상황의 해결책을 두 단계로 말하세요. (예: 친구가 슬퍼 보여요)',
    contentId: 'Sebutkan solusi situasi dalam dua langkah. (Contoh: Temanmu terlihat sedih)',
  },
  {
    sel: '마음건강',
    titleKo: '지금 내 기분을 날씨로 표현',
    titleId: 'Ungkapkan perasaanmu seperti cuaca',
    contentKo: '모둠원이 돌아가며 기분을 날씨 한 단어로 말하세요. 손 모션도 OK!',
    contentId: 'Setiap anggota ungkapkan perasaan dengan satu kata cuaca. Gerak tangan juga OK!',
  },
];
